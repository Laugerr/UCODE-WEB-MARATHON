...
<h1>Notepad mini</h1>
<form method="post">
    <input type="text" name="name" placeholder="Name" style="width: 230px;" required><br><br>
    <select name="importance" style="width: 230px;">
        <option selected>low</option>
        <option>medium</option>
        <option>high</option>
    </select><br><br>
    <textarea name="content" placeholder="Text of note..." style="width: 230px;" required></textarea><br><br>
